...
data_dir    =  '/home/dinhp/data/wowmom_ext/ca/verizon/varied_signal_strength/' 
...
def bar_plot_average_tput_2_users(run_nums):
    ...
    for run_num in run_nums:
        csv_file_list_1.append(data_dir+ 'near_far/phone_1/'
                                     + str(run_num)+'.csv')
        csv_file_list_2.append(data_dir+ 'near_far/phone_2/' 
                                    + str(run_num)+'.csv')
    ...
    fig.savefig(f"figures/{operator}/near_far_{operator}_average_tput")
...
def bar_plot_ca_tput_2_users(run_nums):
    ...
    fig.savefig(f"figures/{operator}/near_far_{operator}_per_carrier_average_tput")
...
def plot_pcell_tput_usage_2_users(rum_nums):
    ...
    fig.savefig(f"figures/{operator}/near_far_{operator}_pcell_tput_usage")
...
def bar_plot_ca_rsrp_2_users(run_nums):
    ...
    fig.savefig(f"figures/{operator}/near_far_{operator}_per_carrier_average_rsrp")
