...
def bar_plot_ca_tput_single_user(run_nums):
    ...
    fig.savefig(f"figures/{operator}_200_300/single_{operator}_per_carrier_average_tput")
...
def bar_plot_ca_tput_2_users(run_nums):
    ...
    fig.savefig(f"figures/{operator}_200_300/2_users_{operator}_per_carrier_average_tput")
...
def bar_plot_ca_tput_3_users(run_nums):
    ...
    fig.savefig(f"figures/{operator}_200_300/3_users_{operator}_per_carrier_average_tput")
...
def plot_pcell_tput_usage_2_users(rum_nums):
    ...
    fig.savefig(f"figures/{operator}_200_300/2_users_{operator}_pcell_tput_usage")
...
def plot_pcell_tput_usage_3_users(rum_nums):
    ...
    fig.savefig(f"figures/{operator}_200_300/3_users_{operator}_pcell_tput_usage")
